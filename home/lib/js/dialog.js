...
MarkBox.prototype = {
	...
	init: function() {
		var mid = document.getElementById(this.mid);
		var cid = document.getElementById(this.cid);
		if (mid || cid) {
	...
	createMarkBox: function(w, h) {
		...
		var html = "<div style='line-height:40px;height:40px;padding-left:10px;width:" + w + ";background:#76A6F5;'><span>" +
			this.title +
